    ...
    <div class="citylist" ref="wrapper">
        <div>
            ...
            <div class="area">
                ...
                <div class="button-list">
                    <div class="button-wrapper" v-for="(item, index) of hotcities" :key="item.id" @click="handelcityclick(item.name)">
            ...
            >
                ...
                <div class="item-list">
                    ...
                    :key="innerItem.id"
                    @click="handellistclick(innerItem.name)"
                    >
                        {{innerItem.name}}
                    </div>
                </div>
...
export default {
    ...
    methods: {
      ...
      handellistclick (list) {
        this.$store.commit('changlist', list)
      }
    }
}
</script>
